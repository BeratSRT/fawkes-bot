...
Kazanan: $replaceText[$replaceText[$checkCondition[$getTextSplitLength==0];true;hiçbiri, yeterli katılımcı yoktu.];false;<@$randomText[$joinSplitText[;]]>.]}{color:RANDOM}{footer: Çekiliş Sona Erdi.:$authorAvatar}]
$channelSendMessage[$channelID;$replaceText[$replaceText[$checkCondition[$getTextSplitLength==0];true;Yeterli katılımcı yoktu.];false;Ödülün sahibi: \`$messageSlice[1]\` is: <@$randomText[$joinSplitText[;]]>, Tebrikler!]]
